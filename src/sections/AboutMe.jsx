...
import PROFILE_PIC from "../assets/images/profile_pic1.png";
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4 mt-6">
            {ABOUT_ME.socialLinks.map((item)=>(
              <a key={item.label} className="cursor-pointer group" href={item.link} target="_blank" rel="noopener noreferrer">
