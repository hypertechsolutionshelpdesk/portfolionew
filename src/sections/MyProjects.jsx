...
import useEmlaCarousel from "embla-carousel-react";
...
const MyProjects = () => {
  const [emblaRef, emblaApi] = useEmlaCarousel({ loop: true, align: "start" });
  ...
  return (
    <section className="bg-background mt-14" id="projects">
